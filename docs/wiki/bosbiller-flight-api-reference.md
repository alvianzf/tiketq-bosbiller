# API PESAWAT - Bosbiller Flight API Specification

This document provides the complete API specification, request payloads, and response structures for the Bosbiller Flight API integrations.

## Error Codes (Tabel Kode Kesalahan)

| **RC (Response Code)** | **Description / Meaning** |
| --- | --- |
| `00` | Sukses |
| `01` | Input data tidak lengkap |
| `02` | Jumlah penumpang dewasa tidak sesuai |
| `03` | Jumlah penumpang anak tidak sesuai |
| `04` | Jumlah penumpang bayi tidak sesuai |
| `09` | Parameter tidak boleh kosong |
| `10` | Pencarian Terjadi Kesalahan |
| `11` | Maskapai Tidak Tersedia |
| `12` | Data Issued tidak ditemukan |
| `13` | Traveller Array Tidak Valid |
| `14` | Contact Array Tidak Valid |
| `15` | Duplikat Booking |
| `17` | Fares ID Kosong atau Kosong Salah Satu |
| `18` | Booking terjadi kesalahan |
| `19` | Kode Booking Tidak Tersedia Untuk Anda |
| `20` | Transaksi Tidak Dapat Dilakukan (ERR:1001) Silahkan hubungi Customer Support |
| `21` | Proses Issued Ulang Terjadi Kesalahan Silahkan hubungi Customer Support |
| `22` | Deposit atau Quota tidak mencukupi |
| `23` | Booking Gagal. Terdapat data yang tidak sesuai, silahkan melakukan proses pencarian jadwal kembali |
| `24` | Proses Issued Terjadi Kesalahan |
| `25` | Terjadi kesalahan dalam update harga, silahkan coba kembali |
| `26` | Issued Tiket Terjadi Kesalahan |
| `30` | Proses Issued Bermasalah, status sebagai SUSPECTED, tiket dianggap ter-issued dan pendebetan tetap dilakukan, segera lakukan rekon dengan Customer Support |
| `32` | Proses Issued Sedang Berlangsung, pembayaran tetap dilakukan, silakan cek booking untuk memastikan status tiket |
| `33` | Tiket Sudah Terisued |
| `34` | Tiket Tidak Dapat di-Issued silahkan hubungi Customer Support |
| `35` | Issued Tiket Bermasalah atau SUSPECTED Silahkan Hubungi Customer Support, untuk kepastian status Issued di maskapai |
| `36` | Kode Booking tidak tersedia |
| `37` | Kode Booking sudah diissued sebelumnya |
| `38` | Jadwal penerbangan sudah tidak tersedia, silahkan coba lagi atau lakukan pencarian ulang |
| `39` | Jumlah Penumpang Dewasa harus ada |
| `40` | Jumlah Penumpang Anak harus ada |
| `41` | Jumlah Penumpang Bayi harus ada |
| `42` | Nominal/harga tiket tidak sesuai |
| `43` | Kode Booking telah kadaluarsa |
| `44` | Booking Gagal |
| `49` | Kursi Tidak Tersedia |
| `50` | Kesalahan Data Penumpang |
| `51` | Please enter correctly according to your ID number |
| `65` | Booking Gagal, Kursi habis atau terjadi kesalahan data |
| `69` | Kode Booking kadaluarsa |
| `71` | Booking gagal, cobalah melakukan search schedule sekali lagi |
| `87` | Email pemesan belum diisi / tidak valid |
| `88` | Gagal melakukan booking, mohon hubungi customer service kami |
| `99` | Gagal Menghubungi biller |

---

## API Endpoints Reference

All requests are sent via **POST** to the base URL:
```http
POST http://117.102.64.238:1212/api.pesawat.php
```

Basic authentication is required for all requests (Username & Password headers).
...
```json
{
  ...
  "data": {
    "quota": "498432290",
    "description": "Development Accountt"
  }
}
```
...
<p>Fungsi travellerMandatory adalah untuk mengetahui data penumpang saat booking yang bersifat mandatory atau tidak. Seaui pada response jika 1 adalah mandatory, jika 0 adalah tidak mandatory namun di tampilkan di sisi User, jika <em>null</em> tidak diperlukan atau bisa di hidden.</p>


**Request Payload Structure:**
```json
{
  "f": "travellerMandatory",
  "airline": "LIO",
  "departure": "YIA",
  "arrival": "CGK"
}
...
{
  "rc": "00",
  "msg": "Jika 1 adalah mandatory, jika 0 adalah tidak mandatory namun di tampilkan di sisi User, jika null tidak diperlukan atau bisa di hidden",
  "airline": "LIO",
  "isDomestic": true,
  "adult": {
    "title": 1,
...
<p>Respon pembayaran sukses adalah RC 00 sedangkan RC32 dana customer tetap ditahan karena proses pembayaran sedang berlangsung, status akhir tiket dapat di cek melalui proses <em>book info</em> atau melalui customer support.</p>
<p>Jika respon payment kosong maka pembayaran dianggap sedang berlangsung atau dana customer tetap ditahan sampai memperoleh status akhir tiket, dengan menghubungi customer support</p>
...
{
  "rc": "32",
  "msg": "Proses Issued Sedang Berlangsung, pembayaran tetap dilakukan, silakan cek booking untuk memastikan status tiket",
  "data": {
    "passengers": {
      "adults": [
        {
